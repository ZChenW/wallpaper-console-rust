# Wallpaper Console v0.1.3

Linux x86_64 follow-up to v0.1.0 focused on dual-display reliability and safer
cross-backend wallpaper apply.

Tags `v0.1.1` and `v0.1.2` were pushed but never published (lockfile / ignored test-module paths); this release carries the intended content.
...
- `wallpaper-console_0.1.3_x86_64.AppImage` — GUI application
- `wallpaper-console-cli_0.1.3_x86_64.tar.zst` — separate CLI bundle
