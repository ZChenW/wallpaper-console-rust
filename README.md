...
- `wallpaper-console-cli_0.1.0_x86_64.tar.zst`
- `SHA256SUMS`
...
Wallpaper Console has no automatic updater. For an AppImage/CLI installation,
...
```bash
rm -f wallpaper-console_0.1.0_x86_64.AppImage
